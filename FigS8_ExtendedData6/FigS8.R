...
FigureS8_main <- plot_grid(Figp1_fixed, Figp3_fixed,
                          ncol = 2, align = "v")
...
FigureS8 <- grid.arrange(arrangeGrob(FigureS8_main, left = y.grob, bottom = x.grob))

save_plot("FigureS8_parts.pdf", plot = FigureS8, base_width = 3.45, base_height = 1.85)
