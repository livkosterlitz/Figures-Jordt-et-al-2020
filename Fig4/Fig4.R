...
Figure4_main <- plot_grid(Figp1_fixed, Figp3_fixed, Figp2_fixed, 
                          Figp4_fixed, ncol = 2, align = "v")
...
Figure4 <- grid.arrange(arrangeGrob(Figure4_main, left = y.grob, bottom = x.grob))

save_plot("Figure4_parts.pdf", plot = Figure4, base_width = 3.45, base_height = 3.7)
